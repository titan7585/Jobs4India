<%@ Page Title="" Language="C#" MasterPageFile="~/Master2.Master" AutoEventWireup="true" CodeBehind="jobdetails.aspx.cs" Inherits="Job_Portal.WebForm14" %>
...
&nbsp;&nbsp;</td>
        ...
        <tr>
            ...
            <td align="left" class="style2">
                <asp:ImageButton ID="imgbtnApply" runat="server" Height="50px" 
                    ImageUrl="~/Images/apply.gif" Width="131px" onclick="imgbtnApply_Click" />
            </td>
            <td>
                &nbsp;</td>
        </tr>
