<%@ Page Title="" Language="C#" MasterPageFile="~/Master.Master" AutoEventWireup="true" CodeBehind="Home.aspx.cs" Inherits="Job_Portal.WebForm1" %>
        ...
        <table class="masterpagetable" cellpadding="0" cellspacing="0" frame="border">
            ...
            <tr>
                <td class="style52" align="center">
                    <asp:ImageButton ID="imgbtnHomeSearch" runat="server" Height="31px" 
            ...
            <tr style="border-bottom:1px solid black;">
                ...
                <td align="center" class="style47" 
                    ...
                    <asp:LinkButton ID="lnkbtnlogin" runat="server" PostBackUrl="~/logincomp.aspx">Login</asp:LinkButton>
                </td>
            </tr>
            <tr>
        ...
        onChange: function (previndex, curindex) {  //event handler fired whenever script changes slide
            ...
            <tr>
                <td class="style71" 
                    ...
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <asp:TextBox ID="txtjsEmailid" runat="server" Width="186px" Height="29px"></asp:TextBox>
                    <br />
                    <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" 
                        ControlToValidate="txtjsEmailid" ErrorMessage="*Enter proper Email" 
...
&nbsp;<asp:TextBox ID="txtjsPassword" runat="server" Width="186px" Height="29px" 
            ...
            <tr>
                <td class="style38" align="center" 
                    ...
                    <asp:ImageButton ID="imgbtnHomeLogin" runat="server" Height="41px" 
                        ImageUrl="~/Images/login.gif" Width="122px" 
                        onclick="imgbtnHomeLogin_Click" />
                </td>
            </tr>
            </table>
    </p>
