<%@ Page Title="" Language="C#" MasterPageFile="~/Master.Master" AutoEventWireup="true" CodeBehind="login.aspx.cs" Inherits="Job_Portal.WebForm2" %>
    ...
    <table class="masterpagetable">
        ...
        <tr>
            ...
            <td class="logintable12">
                <asp:LinkButton ID="lnkbtnForgotPass" runat="server" 
                    PostBackUrl="~/jsForgotpassword.aspx">Forgot Password?</asp:LinkButton>
            </td>
